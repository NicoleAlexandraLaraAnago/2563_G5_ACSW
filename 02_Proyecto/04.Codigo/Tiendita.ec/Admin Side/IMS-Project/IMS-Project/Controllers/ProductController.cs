    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Edit(Product prod)
        {
            if (ModelState.IsValid)
            {
                ...
                var existingProduct = db.Products.Find(prod.ProductID);
                ...
                // Actualiza las propiedades de la entidad recuperada
                db.Entry(existingProduct).CurrentValues.SetValues(prod);
                db.SaveChanges();
                return RedirectToAction("Index", "Product");
            }
